...
public final class Language {
    ...
    public static String TEAM_CHAT_FORMAT = "<#FF0000>Team <white>| <group_display_name> <player> <gray>» <white><message>";
    public static String ALLY_CHAT_FORMAT = "<#03BAFC>Ally <white>| <team_display_name> <group_display_name> <player> <gray>» <white><message>";
